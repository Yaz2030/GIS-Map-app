  ...
  ar: {
    ...
    auth: {
      ...
      errors: {
        ...
        resetTokenInvalid: "رابط إعادة التعيين غير صالح أو منتهي الصلاحية",
        resetFailed: "تعذر تعيين كلمة المرور، حاول مرة أخرى",
        forgotSendFailed: "تعذر إرسال رابط إعادة التعيين، حاول مرة أخرى",
      },
      ...
      forgotConfirmation: "إذا كان البريد مسجلًا، فسيتم إرسال رابط لإعادة تعيين كلمة المرور إليه.",
      backToLogin: "العودة لتسجيل الدخول",
      resetTitle: "تعيين كلمة مرور جديدة",
      resetHint: "أدخل كلمة مرور جديدة لحسابك.",
      resetNewPassword: "كلمة المرور الجديدة",
      resetConfirmPassword: "تأكيد كلمة المرور الجديدة",
      resetSubmit: "تعيين كلمة المرور",
      resetSuccess: "تم تعيين كلمة المرور بنجاح، يمكنك تسجيل الدخول الآن.",
  ...
  en: {
    ...
    auth: {
      ...
      errors: {
        ...
        forgotSendFailed: "Could not send the reset link, please try again",
      },
      ...
      forgotConfirmation: "If the email is registered, a password reset link will be sent to it.",
