...
.toast-container {
  position: fixed;
  /* Always starts fully below the header instead of overlapping it, and
     automatically follows any future change to --header-height (e.g. between
     mobile and desktop) without needing to duplicate the value here */
